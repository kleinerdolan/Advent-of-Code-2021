...
def is_zero(digit):
    ...
    if digit[1] != " " and digit[7] != " " and digit[12] != " " and digit[28] != " " and digit[33] != " " and digit[43] != " ":
        if num_of_chars == 16:
            return True
    return False
...
def validate_config(config):
    zero = is_zero(print_zero(config))
    ...
    # print(nine)
    config_valid = zero and one and two and three and four and five and six and seven and eight and nine
    return config_valid
